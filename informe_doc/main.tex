...
\newcommand{\ProjectTitle}{Informe de Laboratorio}
\newcommand{\ProjectSubject}{Grado de Ingeniería Aeroespacial}
\newcommand{\ProjectAutor}{ Cambra Valcárcel, Pablo \\
             & Del Toro Armas, Mario \\ & Gómez Jiménez, Paula\\ & Pérez Trias, Daniel\\ & Serrano Vega, Carmen\\ & \textbf{Añádanse aquí por orden alfabético} }
\newcommand{\ProjectLocation}{Madrid}
\newcommand{\ProjectDate}{Enero 2025}
% Descomentar si se tiene un repositorio del trabajo
\newcommand{\ProjectGitHub}{https://github.com/MarioDelToro-UPM/informe_lab_MAA.git}
